...
To repozytorium (`aplikacja/`) zawiera wyłącznie wersjonowaną aplikację SmartFach.
Materiały marketingowe znajdują się w osobnym, niewersjonowanym folderze
`marketing/` obok tego repozytorium (poza `.git`) i nigdy nie powinny do niego trafić.
