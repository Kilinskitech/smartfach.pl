  ...
  return {
    ...
    sections: [
      ...
      { title: "6. Miesięczny limit i jego zwiększenie", paragraphs: [
        "Ze względów bezpieczeństwa obowiązuje ograniczenie do 20 prób zapytań na godzinę na użytkownika oraz jedno przetwarzane zadanie na konto jednocześnie. Przed wysłaniem zapytania część dostępnego limitu jest tymczasowo rezerwowana. Utrata połączenia może wymagać sprawdzenia próby przez obsługę przed zwolnieniem rezerwacji; sama rezerwacja nie jest dodatkową płatnością.",
        ...
        "Limit planu odnawia się przy rozpoczęciu nowego okresu rozliczeniowego; niewykorzystana część podstawowego limitu nie przechodzi na kolejny okres. Próbę obejmuje limit wybranego planu. Po wyczerpaniu dostępnego limitu dalsza praca AI zostaje zablokowana do odnowienia lub świadomego zakupu zwiększenia. Nie pobieramy automatycznie dodatkowych opłat za przekroczenie limitu. Operacje zakończone błędem bez dostarczenia odpowiedzi nie powinny obciążać limitu; błędne naliczenie korygujemy po zgłoszeniu.",
