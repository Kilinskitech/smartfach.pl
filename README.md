...
To repozytorium Git (`aplikacja/`) zawiera wyłącznie kod, konfigurację, migracje
i dokumentację produktu SmartFach — bezpośrednio w swoim korzeniu, bez
dodatkowego katalogu aplikacji. Strategia, materiały operacyjne i multimedia
marketingu znajdują się osobno, w niewersjonowanym folderze `marketing/`
obok tego repozytorium, oraz w Google Drive.
