...
| AI               | OpenRouter; routing jakości i kontrolowany fallback | Luna / Terra → Gemini 3.5 Flash                         |
...
Zdjęcia nadal wymagają przyszłego Storage. `openai/gpt-5.6-luna` obsługuje zwykłe
rozmowy, `openai/gpt-5.6-terra` start biznesu, obrazy i trudniejsze zadania, a stały
`google/gemini-3.5-flash` chroni usługę przed awarią jednego dostawcy. Rzeczywisty
